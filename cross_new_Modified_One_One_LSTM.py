...
for p_l in pred_length:     
    dataset = read_csv('./多元data/all_data_weekly.csv', header=0)
    df1 = dataset
    ...
    for Partnumber in device:  
        ...
        with open(f'./Progress-一元/LSTM/{p_l}-{Partnumber}-{hidden_size_value}-{num_layers_value}-{learning_rate_value}.txt',
                  'w') as file:
            pass  
